...
class EarningsSummary {
  ...
  double? get earningsChange {
    if (previousEarnings == null || previousEarnings == 0) return null;
    return estimatedEarnings - previousEarnings!;
  }

  double? get earningsChangePercent {
    if (previousEarnings == null || previousEarnings == 0) return null;
    return (estimatedEarnings - previousEarnings!) / previousEarnings! * 100;
  }
}
